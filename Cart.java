...
import java.util.Scanner;
    ...
    public class Cart {
        ...
        public void receiptBody() {
            ...
            String todayDate = this.myDate();
            String cashier = this.cashierName();
            String customer = this.customerName();
            ...
            Iterator var18 = saveCart.iterator();

            while(var18.hasNext()) {
                Cart num = (Cart)var18.next();
                System.out.println(num);
            }

            System.out.println(this.singleLine);
            System.out.printf("%42s%10s%n", "Sub Total:", this.subTotal);
            this.discount = this.subTotal * this.discountPrice / 100;
            System.out.printf("%42s%10s%n", "Discount:", this.discount);
            this.vat = (double)this.subTotal * this.vatPrice / 100.0;
            System.out.printf("%42s%10s%n", "VAT @ 17.50:", this.vat);
            System.out.println(this.doubleLine);
            double billTotal = (double)(this.subTotal + this.discount) + this.vat;
            ...
            double amountPaid = (double)this.userInput.nextInt();
            ...
            if (amountPaid < billTotal) {
                ...
                System.out.printf("%42s%10s%n", "Balance:", balance);
                System.out.println(this.doubleLine);
                System.out.print("\t\t THANKS FOR YOUR PATRONAGE \n ");
                System.out.print(this.doubleLine);
            }
